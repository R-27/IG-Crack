# !/bin/bash
# Author       	   : ./R-27
# Present From     : Indonesian Fighter Cyber
# Follow Instagram : _Rafszz
...
# If user click ctrl + c = program stopped and remove all tmp file in dir IG-Crack
function ctrl_c(){
	if [[ ! -e *.tmp* ]]; then
		echo -e "${white}"
	else
...
3\e[1;31m. \e[1;37mCracking From Target List\e[1;37m
'''
